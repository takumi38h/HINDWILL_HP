                ...
                <div className="w-full md:w-1/2 h-full flex flex-col">
                            ...
                            <ul className="grid grid-cols-2 gap-x-8 gap-y-6">
                                {MENU_ITEMS.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <span className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight group-hover:text-red-600 transition-colors duration-300">
                                                {item.en}
                                            </span>
                                            <span className="text-xs text-gray-500 group-hover:text-red-600 transition-colors duration-300">
                                                {item.jp}
                                            </span>
                                        </Link>
                                    </li>
                    ...
                    >
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-200 hover:bg-red-600 transition-colors duration-300 flex items-center justify-center group">
                                <svg className="w-3.5 h-3.5 text-gray-600 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-gray-200 hover:bg-red-600 transition-colors duration-300 flex items-center justify-center group">
                                <svg className="w-3.5 h-3.5 text-gray-600 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
