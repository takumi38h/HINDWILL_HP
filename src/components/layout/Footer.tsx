            ...
            <div className="max-w-[1200px] mx-auto px-6">
                ...
                <div className="mt-12 pt-8 border-t border-gray-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
                        <nav className="flex flex-wrap justify-center gap-6 text-[12px] text-gray-400">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-8 h-8 border border-gray-700 rounded-full flex items-center justify-center hover:bg-orange-500 hover:text-white hover:border-orange-500 transition-colors">
